...
<div class="flex justify-center bg-gray-700">
    <div class="w-1/2 bg-gray-800 rounded-lg shadow-xl p-6">
        <div class="">
            <div class="">
                <div class="text-semibold text-3xl text-center text-orange-500 pb-8">Add New Home</div>
                    ...
                    <form action="/admin/home/store" method="post">
                        ...
                        <div class="p-2">
                            ...
                            <div class="rounded p-2">
                                <div>
                                    <input type="radio" name="type" id="type_house" value="house" {{ old('type') == 'house' ? 'checked' : ''}}>
                                    <label for="type_house">
                                        House
                                    </label>
                                </div>
                                <div>
                                    <input type="radio" name="type" id="type_duplex" value="duplex" {{ old('type') == 'duplex' ? 'checked' : ''}}>
                                    <label for="type_duplex">
                                        Duplex
                                    </label>
                                </div>
                                <div>
                                    <input type="radio" name="type" id="type_townhouse" value="townhouse" {{ old('type') == 'townhouse' ? 'checked' : ''}}>
                                    <label for="type_townhouse">
                                        Townhouse
                                    </label>
                                </div>
                                <div>
                                    <input type="radio" name="type" id="type_apartment" value="apartment" {{ old('type') == 'apartment' ? 'checked' : ''}}>
                        ...
                        <div class="p-2">
                            <div class="flex">
                                <div class="w-full">
                                    ...
                                    <input name="bedrooms" type="number" class="w-2/3 rounded p-2 bg-gray-800" id="bedrooms" min="1" value="{{old('bedrooms')}}"
                                ...
                                <div class="w-full">
                                    ...
                                    <input name="bathrooms" type="number" class="w-2/3 rounded p-2 bg-gray-800" id="bathrooms" min="1" value="{{old('bathrooms')}}"
                        ...
                        <div class="p-2">
                            ...
                            <input name="price" type="number" class="w-full rounded p-2 bg-gray-800" id="price" min="0" value="{{old('price')}}"
                        ...
                        <div class="p-2">
                            ...
                            <div class="">
                                ...
                                aria-describedby="descriptionHelp" placeholder="Description">{{old('description')}}</textarea>
                            </div>
